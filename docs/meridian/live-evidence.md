...
The current integrated runtime baseline is `dev` at `245ba838499212ee36ee556e0a6de7c671b01f76`. PR #43 delivered the pre-intent `INSUFFICIENT_FUNDS` business outcome, PR #44 repaired CLI browser inspection under the actual `tsx` loader, PR #45 associated sibling transfer review facts with the posting form, PR #46 made the Terminal-only CLI approval handoff explicit, PR #47 repaired evidence metadata trust boundaries, and PR #49 repaired canonical discovery preflight and promotion bindings offline. PR #49's reviewed head and merge gates passed. Their source gates are summarized in [the checkpoint report](report.md#architecture-and-delivered-runtime). These integrations do not promote the transfer draft, create a replay or change any historical producing source SHA.
...
Evidence-metadata [PR #47](https://github.com/goodwiins/computer-use-automation-system/pull/47) at `66a9fb0b14450a81311c515e0d61b07a0a2449cb` passed final review, 278 tests/17 files, typecheck, validation, scoped re-review and hosted workflow `33950233434` / producer `101263489851`. It merged as `2c7f4ed4577fe01bbfb441525b7cccc14128c46b` with an identical reviewed tree; merge workflow `33950705840` / producer `101264800819` passed. Existing private evidence was not rewritten. Discovery-contract [PR #49](https://github.com/goodwiins/computer-use-automation-system/pull/49) fixed the audited canonical preflight and promotion-binding gap offline at reviewed head `e507e8a`; 197 focused and 288 full tests, head workflow `33952285341` / producer `101269200295`, and hosted code/security reviews passed without findings. It merged as current `245ba838499212ee36ee556e0a6de7c671b01f76` with equal tree `654065a59c060920524af07ab12d2e7bffcae320`; merge workflow `33952963465` / producer `101271025160` passed. It changed no live operation or accepted artifact. A separate source audit confirms discovery still lacks replay's profile-detector pass; known business, fatal or recoverable pages can reach model work or lower-layer success. This is not evidence of an artifact or POST bypass, and EXC-02 through EXC-07 remain incomplete.
