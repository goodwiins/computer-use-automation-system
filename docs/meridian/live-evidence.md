...
| `meridian-funds-transfer@1.0.0` | — | — | — | no artifact, approval or verified posting; incomplete | no safety evaluation or evidence path; requires fresh discovery, replay and resulting-state read |
